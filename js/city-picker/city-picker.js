    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                textspan = '<span class="city-picker-span" style="' +
                    ...
                    '<span class="title"></span><div class="city-clear">×</div><div class="arrow"></div>' + '</span>',
        ...
        refresh: function (force) {
            ...
            if (val.substr(2) == '0000') {
                ...
                val = val.substr(0,2)+'0000/'+ val;
            } else {
                val = val.substr(0,2)+'0000/'+ val.substr(0,4)+'00/'+val;
            }
            val = val.split('/');
            $.each(this.dems, $.proxy(function (i, type) {
        ...
        bind: function () {
            ...
            var _this = this;
            $(document).on('click','.city-clear',function(){
                _this.reset();
                return false;
            });
        },
